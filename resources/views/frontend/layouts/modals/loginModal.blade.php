                ...
                <div class="modal-body">
                    <div class="tab-content">
                        <div class="tab-pane container active" id="login">
                            ...
                            <span class="success-response text-warning">{{(session()->get('flash_success'))}}</span>
                            <form class="contact_form" id="loginForm" action="{{route('frontend.auth.login.post')}}"
                                  method="POST" enctype="multipart/form-data">
                                <a href="#" class="go-register float-right text-info pl-0">
                                ...
                                <div class="contact-info mb-2">
                                    ...
                                    <a class="text-info p-0 d-block text-left my-2"
                        ...
                        <div class="tab-pane container fade" id="register">
                            ...
                            <form id="registerForm" class="contact_form" action="#" method="post">
                                {!! csrf_field() !!}
                                <a href="#" class="go-login float-left text-info pr-0">
                                    @lang('labels.frontend.modal.already_user_note') </a>
                                <div class="contact-info mb-2">
